<template>
  <el-upload class="avatar-uploader" :accept="accept" :action="action" :headers="headers" :show-file-list="false"
    :auto-upload="autoUpload" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload"
    :on-error="handleFail">
